 ...
 *
 *  $Id: tomoe-writing.h,v 1.10 2006/12/01 01:35:42 ikezoe Exp $
 */
...
#define TOMOE_WRITING_THRESHOLD 50
...
void            tomoe_writing_move_to           (TomoeWriting  *writing,
                                                 gint           x,
                                                 gint           y);
//void            tomoe_get_size                  (TomoeWriting *writing, gint *result);
...
//TomoePoint     *tomoe_writint_get_last_point    (TomoeWriting  *writing);
